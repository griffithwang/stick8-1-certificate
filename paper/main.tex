...
\end{center}
The initial code snapshot is commit
\begin{verbatim}
7306c8d80b231e5d400b036cb77f513c89627707
\end{verbatim}
...
release assets rather than ordinary Git objects. Release
\code{v0.1.0-audit} is being prepared; its publication and verification
record must be confirmed before this manuscript is submitted.
Author metadata and arXiv submission are still pending.
Local incremental compilation is recorded separately from a rebuild
of all local modules; upstream mathlib dependencies use a pinned cache.
